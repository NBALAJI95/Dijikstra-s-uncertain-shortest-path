...
if __name__ == '__main__':
	...
	output = str('\n') + str('PESSIMIST') + str(',') + str('-'.join(path_res)) + str(',') + str(mean) + str(',')  + str(mean_minus_sd) + str(',')  + str(mean_plus_sd) + str(',')  + str(mean_plus_twice_sd) + str(',')  + str(c_squared) + str(',')  + str(dispersion_index) + str(',')  + str(hops)
	fh.write(output)
